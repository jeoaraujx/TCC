...
É importante estabelecer uma distinção conceitual sobre o termo \enquote{Mapa de Conhecimento} utilizado nesta pesquisa. Diferentemente da Representação de Conhecimento clássica, que se baseia em ontologias formais e relações lógicas explícitas (como grafos de conhecimento), esta abordagem fundamenta-se no paradigma do Mapeamento da Ciência. Segundo \citeonline{Borner_2010}, mapas de ciência são representações visuais que utilizam a metáfora espacial para comunicar a estrutura e a evolução de campos científicos.

Neste contexto, a validade do \enquote{mapa} não advém de regras ontológicas pré-definidas, mas sim da proximidade semântica. Assume-se a premissa da Hipótese Distribucional, onde a proximidade espacial entre dois pontos (documentos) no gráfico do WizMap representa uma alta similaridade de conteúdo (embeddings). Portanto, operacionalmente, define-se o artefato como um mapa de conhecimento no sentido de navegação e descoberta de estruturas latentes, permitindo ao usuário perceber agrupamentos (clusters) como domínios de conhecimento consolidados.