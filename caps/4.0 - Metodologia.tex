...
A validação quantitativa foca em avaliar objetivamente a qualidade dos tópicos gerados pelo \textit{pipeline} do \gls{bertopic}. Serão utilizadas métricas consolidadas na literatura de \gls{pln} para mensurar tanto a consistência interna quanto a distinção entre os grupos:
